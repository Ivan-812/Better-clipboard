...
class Ui_home_button_settings(object):
    def setupUi(self, home_button_settings):
        ...
        self.popup_checkbox = QtWidgets.QCheckBox(self.edit_group)
        self.popup_checkbox.setObjectName("popup_checkbox")
        self.type_layout.addWidget(self.popup_checkbox)
        self.color_button = QtWidgets.QPushButton(self.edit_group)
        self.color_button.setObjectName("color_button")
        self.type_layout.addWidget(self.color_button)
        self.type_layout.setStretch(0, 3)
        self.type_layout.setStretch(1, 2)
    ...
    def retranslateUi(self, home_button_settings):
        ...
        self.popup_checkbox.setText(_translate("home_button_settings", "PopUp"))
